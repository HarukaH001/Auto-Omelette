...
export const links = [
    ...
    // Layer 2
    { from: 3, to: 4, text: "30 ", segmentIndex: 2, segmentFraction: 0.5, points: [245, -160, 245, 100] },
    ...
    { from: 3, to: 3, text: "20, หมูสับ, ไก่สับ,\nConfirm, Reset", segmentIndex: 1, segmentFraction: 0.5, points: [235, -200, 235, -250, 300, -250, 300, -190, 275, -190] },
    ...
    { from: 4, to: 8, text: "1 ฟอง", segmentIndex: 2, segmentFraction: 0.5, points: [273, 130, 400, 130] },
    ...
    { from: 5, to: 5, text: "40, หมูสับ, ไก่สับ,\nConfirm, Reset", segmentIndex: 1, segmentFraction: 0.5, points: [250, 340, 250, 390, 210, 390, 210, 339] },
    ...
    { from: 6, to: 2, text: "Confirm", segmentIndex: 2, segmentFraction: 0.5, points: [550, -180, 800, -180, 800, 10, 1010, 10] },
    { from: 6, to: 6, text: "1 ฟอง, 2 ฟอง, หมูสับ, ไก่สับ, Reset", segmentIndex: 1, segmentFraction: 0.5, points: [500, -200, 500, -250, 600, -250, 600, -190, 550, -190] },
    ...
    { from: 9, to: 13, text: "ไก่สับ", segmentIndex: 2, segmentFraction: 0.5, points: [450, 330, 520, 330, 520, 390, 600, 390] },
    { from: 9, to: 9, text: "1 ฟอง, 2 ฟอง,\nConfirm, Reset", segmentIndex: 1, segmentFraction: 0.5, points: [450, 338, 450, 400, 410, 400, 410, 338] },

    // Layer 4
    { from: 10, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 10, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 10, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    ...
    { from: 10, to: 15, text: "ไก่สับ", segmentIndex: 2, segmentFraction: 0.3, points: [] },
    ...
    { from: 11, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 11, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 11, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 11, to: 7, text: "2 ฟอง", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 11, to: 14, text: "หมูสับ", segmentIndex: 1, segmentFraction: 0.1, points: [670, 190, 715, 190, 715, 165, 810, 165, 810, 140] },
    { from: 11, to: 15, text: "ไก่สับ", segmentIndex: 1, segmentFraction: 0.5, points: [635, 209, 635, 230, 820, 230, 820, 210] },
    { from: 11, to: 8, text: "1 ฟอง ,Reset", segmentIndex: 2, segmentFraction: 0.5, points: [615, 209, 615, 230, 500, 230, 500, 140, 448, 140] },
    { from: 11, to: 11, text: "Confirm", segmentIndex: 1, segmentFraction: 0.2, points: [660, 210, 660, 255, 625, 255, 625, 210] },

    { from: 12, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 12, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 12, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    ...
    { from: 13, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 13, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    ...
    // Layer 5
    { from: 14, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 14, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 14, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 14, to: 7, text: "2 ฟอง", segmentIndex: 1, segmentFraction: 0.5,},
    ...
    { from: 14, to: 8, text: "1 ฟอง, Reset", segmentIndex: 1, segmentFraction: 0.5, points: [800,120,780,120,780,155,620,155,620,168,425,168,425,140] },

    { from: 15, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 15, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 15, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 15, to: 7, text: "2 ฟอง", segmentIndex: 1, segmentFraction: 0.5,},
    ...
    { from: 16, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 16, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 16, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
    ...
    { from: 16, to: 9, text: "2 ฟอง, Reset", segmentIndex: 1, segmentFraction: 0.5, points: [830, 300, 830, 275, 415, 275, 415, 300]},

    { from: 17, to: 3, text: "20", segmentIndex: 1, segmentFraction: 0.5},
    { from: 17, to: 4, text: "30", segmentIndex: 1, segmentFraction: 0.5,},
    { from: 17, to: 5, text: "40", segmentIndex: 1, segmentFraction: 0.5,},
